...
# META     },
# META     "environment": {
# META       "environmentId": "50ab0f13-8433-931a-4dd5-b5ed45e32b88",
...
df = spark.read.format("delta").load(
    "Tables/conformed/marketing_performance"
).limit(100000).cache()
...
target_col = re.sub('[^A-Za-z0-9_]+', '_', "spend")
...
mlflow.set_experiment("S_AutoML-AutoMLExperiment")
...
settings = {
    ...
    "force_cancel": True, 
    "seed": 41 , # Random seed 
    "mlflow_exp_name": "S_AutoML-AutoMLExperiment",  # MLflow experiment name
...
with mlflow.start_run(run_name="S_AutoML-AutoMLModel") as run:
    automl.fit(
        X_train=X_train, 
...
registered_model = mlflow.register_model(model_uri=model_path, name="S_AutoML-AutoMLModel")
...
model_name = "S_AutoML-AutoMLModel"
...
saved_name = "Tables/ml_demo/marketing_performance_predictions".replace(".", "_")
